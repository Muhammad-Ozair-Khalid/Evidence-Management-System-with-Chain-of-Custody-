      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        ...
        {mismatch ? (
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="rounded-md border border-accent-integrity/30 bg-accent-integrity/5 p-3 space-y-3">
              <p className="text-xs font-semibold uppercase tracking-wide text-accent-integrity">
              ...
              {hasStoredFile ? (
                ...
                <div className="space-y-3">
                  <p className="text-sm text-canvas-foreground">
                    ...
                    external forensic tool (e.g. FTK Imager). Double-entry
